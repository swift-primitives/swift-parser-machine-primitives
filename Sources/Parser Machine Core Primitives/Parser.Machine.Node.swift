...
extension Parser.Machine {
    ...
    public typealias Node<Input: Parser_Primitives.Parser.Input & ~Copyable, Failure: Error & Sendable> =
    ...
    @safe
    public struct Leaf<Input: Parser_Primitives.Parser.Input & ~Copyable, Failure: Error & Sendable>: @unchecked Sendable
    where Input: Sendable {
        @usableFromInline
